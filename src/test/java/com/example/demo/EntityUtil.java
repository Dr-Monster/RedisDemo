...
public class EntityUtil {
    ...
    private final String moduleName = "lrm"; // 对应模块名称（根据自己模块做相应调整!!!务必修改^_^）

    private final String bean_path = "D:/entity_bean_lcs";

    private final String mapper_path = "D:/entity_mapper_lcs";

    private final String xml_path = "D:/entity_mapper_lcs/xml";
    ...
    private final String url = "jdbc:mysql://localhost:3306/localtest";
...
//            if ( tableName.toLowerCase().startsWith("fms_") ) {
...
//        bw.newLine();
    ...
    private void buildSQL( BufferedWriter bw, List<String> columns, List<String> types ) throws IOException {
        ...
        bw.write("\t<!-- 添加 （匹配有值的字段）-->");
        bw.newLine();
        bw.write("\t<insert id=\"insertSelective\" keyProperty=\"id\" useGeneratedKeys=\"true\"  parameterType=\"" + bean_package + "." + beanName + "\">");
        bw.newLine();
        bw.write("\t\t INSERT INTO " + tableName);
        bw.newLine();
